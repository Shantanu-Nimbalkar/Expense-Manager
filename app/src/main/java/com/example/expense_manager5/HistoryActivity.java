...
public class HistoryActivity extends AppCompatActivity implements DatePickerDialog.OnDateSetListener {
    ...
    private DatabaseReference expensesRef, personalRef,reference;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reference=FirebaseDatabase.getInstance().getReference("expenses").child(onlineUserId);
    ...
    public void onDateSet(DatePicker datePicker, int year, int month, int dayOfMonth) {
        ...
        reference = FirebaseDatabase.getInstance().getReference("personal").child(onlineUserId);
